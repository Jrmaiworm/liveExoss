...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './estacao.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ESTACAO_LIST actions', async () => {
    ...
    it('dispatches FETCH_ESTACAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ESTACAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ESTACAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ESTACAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ESTACAO actions', async () => {
      const expectedActions = [
        {
