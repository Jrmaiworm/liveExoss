...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './captura.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CAPTURA_LIST actions', async () => {
    ...
    it('dispatches FETCH_CAPTURA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CAPTURA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CAPTURA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CAPTURA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CAPTURA actions', async () => {
      const expectedActions = [
        {
